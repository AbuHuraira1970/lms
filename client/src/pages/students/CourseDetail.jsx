...
const CourseDetail = () => {
  ...
  const { curreny, allCourses, calculateRating, calculateChapterTime, calculateCourseDuration, calculateTotalLecture, backendUrl, userData, getToken } = useContext(appContext)
